...
const Navbar = () => {
    ...
    const navLinkClass = ({ isActive }) =>
        isActive
            ...
            : 'hover:text-primary transition text-base text-base-content';
    ...
    return (
        <div className="bg-base-100 text-base-content shadow-lg">
            <div className="navbar shadow-sm max-w-7xl mx-auto">
                <div className="navbar-start">
                    ...
                    <Slide direction="left">
                        <Link className="flex justify-center items-center text-xl font-bold text-base-content" to="/">
                            <img
                        ...
                        <>
                            <div className="tooltip tooltip-bottom" data-tip={user.displayName || 'User'}>
                                <img
                                    ...
                                    alt="User Avatar"
                                    className="w-10 h-10 rounded-full border-2 cursor-pointer border-base-content/20"
                                />
                            </div>
                            <button
