...
const Slider = () => {
    // Function to handle the navigation between slides
    const handleSlideChange = (e, target) => {
        e.preventDefault(); // Prevent default behavior of anchor tag/link
        ...
        <div className='bg-slate-800 text-white py-24 px-6'>
            <div className="carousel w-full rounded-lg shadow-lg">
                ...
                <div id="slide1" className="carousel-item relative w-full">
                    {/* Centered Game Info */}
                    <div className="absolute inset-0 flex flex-col items-center justify-center text-center z-20 bg-black/50 p-4">
                        ...
                        <button className="bg-[#f59e0b] hover:bg-[#d97706] px-6 py-2 rounded-md font-semibold text-[#0f172a] transition-all duration-300 ease-in-out hover:scale-105">
                            Play Now
                        </button>
                    </div>
                    <img
                    ...
                    <div className="absolute left-5 right-5 top-1/2 flex -translate-y-1/2 transform justify-between z-30">
                        <button
                            ...
                            className="btn btn-circle hover:bg-gray-700 transition duration-300"
                        >
                            ❮
                        </button>
                        <button
                ...
                <div id="slide4" className="carousel-item relative w-full">
                    <div className="absolute inset-0 flex flex-col items-center justify-center text-center z-20 bg-black/50 p-4">
                        ...
                        <button className="text-xl text-[#cbd5e1] mb-6 transition-all duration-300 ease-in-out hover:scale-105">
                            Discover More
                        </button>
                    </div>
                    <img
